# Generated by Django 2.1.7 on 2019-04-06 01:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('deleted_at', models.DateTimeField(null=True)),
                ('activity_level', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fact.ActivityLevel')),
        ...
        migrations.AddField(
            model_name='calorieintake',
            name='food',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='fact.Food'),
        ),
        migrations.AddField(
            model_name='calorieintake',
            name='user',
