...
from .dataset_personal_label import DatasetPersonalLabel

class DatasetPersonal(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    label = models.ForeignKey(DatasetPersonalLabel, on_delete=models.CASCADE)
