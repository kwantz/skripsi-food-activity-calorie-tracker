...
def api_member_activity(request):
    ...
    if request.method == "DELETE":
        ...
        return JsonResponse({"status": activities.query, "message": "Success", "dump": list(activities.values('id')), "time_1": requested_at, "time_2": dateutil.parser.parse(requested_at)})
